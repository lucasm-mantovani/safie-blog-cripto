...
async function init() {
  ...
  if (destaqueInfo.estado === 'B' && destaqueInfo.artigo_slug) {
    ...
    if (encontrado) {
      destaqueArtigo = encontrado;
      isMaisLido = true;
    }
  }

  // Galeria: os 12 mais recentes excluindo o destaque
