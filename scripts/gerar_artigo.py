...
SYSTEM_PROMPT = """Você é um especialista em direito e contabilidade aplicados ao mercado de criptoativos no Brasil, escrevendo para o blog SAFIE Cripto (cripto.safie.blog.br).
...
1. FORMATO BLUF (conclusão primeiro): a PRIMEIRA frase do "resumo_executivo" responde
   ...
   Contexto e ressalvas vêm nas frases seguintes. Errado: "Nos últimos anos, o mercado
   cripto tem mudado...". Certo: "A Lei 14.478/2022 exige autorização do Banco Central
   para prestadoras de serviços de ativos virtuais a partir de X."
...
2. KEY TAKEAWAYS: o campo "key_takeaways" traz de 3 a 5 fatos-âncora citáveis do artigo.
   ...
   Certo: "A Lei 14.478/2022 (Marco Legal das Criptomoedas) atribui ao Banco Central a
   competência para autorizar e supervisionar prestadoras de serviços de ativos virtuais."
...
5. CITAÇÃO DE SÓCIO: o campo "citacao_socio" traz uma análise em primeira pessoa
   ...
   Escolha pelo tema: "Lucas Mantovani" para societário, contratos, direito digital e
   LGPD; "Ítalo Cunha" para tributário, fiscal e financeiro.
...
Apresente a notícia como ponto de partida e aprofunde a análise jurídica e contábil."""
    ...
    return f"""Escreva um artigo completo para o blog SAFIE Cripto sobre o tema "{tema_nome}".
...
{{
  ...
  "impacto_pratico": "(2 a 3 parágrafos sobre o impacto prático para empresas cripto, investidores e profissionais, em HTML com tags <p>)",
...
- O FAQ deve ter entre 3 e 5 perguntas reais que usuários fariam ao ChatGPT ou ao Google sobre o tema
...
def montar_artigo_completo(dados_claude: dict, noticia: dict, config_blog: dict) -> dict:
    ...
    url_blog  = config_blog.get("url_completa", "https://cripto.safie.blog.br")

    # Monta HTML do corpo completo
    ...
    schema = [
        {
            ...
            "publisher": {"@type": "Organization", "name": "SAFIE Cripto", "url": url_blog},
    ...
    return {
        "slug": slug,
        "titulo": titulo,
        "meta_titulo": f"{titulo} — SAFIE Cripto",
